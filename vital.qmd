...
\end{block}
  ...
  * $\mu(x)=$ mean $s_t(x)$ across years.
  * $\phi_j(x)$ and $\beta_{tj}$ estimated using principal component \rlap{analysis.}
  * $\beta_{1j},\dots,\beta_{Tj}$ modelled with ARIMA for products and ARMA for ratios (to ensure stationary sex-ratios)

\begin{textblock}{5.4}(10.2, -0.15)
\begin{alertblock}{}\fontsize{12}{12}\sf
Hyndman, Booth \& Yasmeen (\textit{Demography}, 2013)
\end{alertblock}
\end{textblock}
...
\only<2->{\begin{textblock}{8.8}(0.2,5.8)
\begin{alertblock}{}\fontsize{15}{30}\sf
\href{https://robjhyndman.com/mpidr2024}{\raisebox{-0.1cm}{\includegraphics[width=1cm]{front}}~~ robjhyndman.com/mpidr2024}

\href{https://pkg.robjhyndman.com/vital/}{\raisebox{-0.5cm}{\includegraphics[width=1cm]{vital-hex}}~~ pkg.robjhyndman.com/vital}
\end{alertblock}
\end{textblock}}
