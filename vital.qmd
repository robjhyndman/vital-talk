...
\begin{alertblock}{}\fontsize{15}{20}\sf
\href{https://robjhyndman.com/mpidr2024}{\raisebox{-0.25cm}{\includegraphics[width=1.4cm]{front}}~~ robjhyndman.com/mpidr2024}\vspace*{0.15cm}

\href{https://pkg.robjhyndman.com/vital/}{\raisebox{-0.65cm}{\includegraphics[width=1.4cm]{vital-hex}}~~ pkg.robjhyndman.com/vital}
\end{alertblock}
\end{textblock}}
